...
`git clone https://github.com/Yusein44/new_food_delivery_web.git`

2. Navigate to the project directory:
`cd new_food_delivery_web`
...
* **Route Protection:** Unauthenticated users are redirected to the Login page. Logged-in users are restricted from accessing generic Login/Register pages.
...
* **Route Guards:** `@login_required` decorators used to protect private views.
